"""Procurement Agent - Main Agent Implementation."""
...
class ProcurementAgentAgent:
    ...
    def __init__(self):
        ...
        self.procurement_enabled = True
        self.compliance_enabled = True
        self.reporting_enabled = True
        self._tool_dispatch = {
            "create_requisition": self.tools.create_requisition,
            "evaluate_proposals": self.tools.evaluate_proposals,
            "generate_rfp": self.tools.generate_rfp,
            "track_contract": self.tools.track_contract,
            "analyze_spend": self.tools.analyze_spend,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['procurement', 'compliance', 'reporting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "evaluate_proposals": ['evaluate', 'proposals'],
            "generate_rfp": ['generate', 'rfp'],
            "track_contract": ['track', 'contract'],
            "analyze_spend": ['analyze', 'spend'],
        }
