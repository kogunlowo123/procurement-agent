"""Procurement Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Procurement Agent, an enterprise finance automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Procurement Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Procurement Agent:
