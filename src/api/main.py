"""Procurement Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Procurement automation agent that manages purchase requisitions, evaluates vendor proposals, automates RFP processes, tracks contract compliance, and optimizes procurement spend.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
